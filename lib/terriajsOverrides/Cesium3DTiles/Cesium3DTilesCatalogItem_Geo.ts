...
import Cesium3dTilesMixin_Geo from "./Cesium3dTilesMixin_Arbm";
import FeatureInfoUrlTemplateMixin from "terriajs/lib/ModelMixins/FeatureInfoUrlTemplateMixin";
...
export default class Cesium3DTilesCatalogItem_Geo extends SearchableItemMixin(
  FeatureInfoUrlTemplateMixin(
    Cesium3dTilesMixin_Geo(CreateModel(Cesium3DTilesCatalogItemTraits))
  )
) {
  static readonly type = "3d-tiles-geocentric";
  readonly type = Cesium3DTilesCatalogItem_Geo.type;
...
const openInfoPanelForFeature = action(
  (
    item: Cesium3DTilesCatalogItem_Geo,
