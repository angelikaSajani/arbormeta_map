// ================================================================================================================================================
// Overridden only because of a single bug as marked below (search for AIS), where the original passes two positional parameters instead of one.
// ================================================================================================================================================
...
import Cesium from "terriajs/lib/Models/Cesium";
import { BaseModel } from "terriajs/lib/Models/Definition/Model";
import Terria from "terriajs/lib/Models/Terria";
import ViewerMode, {
  MapViewers,
  setViewerMode
} from "terriajs/lib/Models/ViewerMode";
              ...
              <FlexGrid gap={1} elementsNo={4}>
                {this.props.terria.baseMapsModel.baseMapItems.map((baseMap) => (
                  <StyledBasemapButton
                    ...
                    onMouseLeave={this.mouseLeaveBaseMap.bind(this)} // AIS: line with bugfix  < =======================================
