// ================================================================================================================================================
// Overridden to
// - auto-populate the form with user data if a user is logged in
// - specify a title (fixed at the moment)
// = on submit, send Authorization header if user is logged in
// ================================================================================================================================================
...
import sendFeedback from "./sendFeedback"; // AIS: our version has one extra parameter: viewState    < ==================
import Box from "terriajs/lib/Styled/Box";
import Button, { RawButton } from "terriajs/lib/Styled/Button";
import Checkbox from "terriajs/lib/Styled/Checkbox";
import { GLYPHS, StyledIcon } from "terriajs/lib/Styled/Icon";
import Input, { StyledTextArea } from "terriajs/lib/Styled/Input";
...
} from "terriajs/lib/ReactViews/Custom/parseCustomMarkdownToReact";
import { withViewState } from "terriajs/lib/ReactViews/Context"; // AIS: using WithViewState_Arbm instead    < ==================
import { applyTranslationIfExists } from "terriajs/lib/Language/languageHelpers";

import {
  ViewState_Arbm as ViewState,
  WithViewState_Arbm
} from "./ViewState_Arbm"; // AIS: to replace WithViewState    < ==================

interface IProps extends WithTranslation, WithViewState_Arbm {
  theme: DefaultTheme;
}
  ...
  onSubmit(e: React.FormEvent<HTMLFormElement | HTMLDivElement>) {
    ...
    if (
      ...
      sendFeedback({
        ...
        title: "From TerriaMap Integration",
